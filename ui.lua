...
local themes = {
    ...
    Lime = {
        ...
        ["Window Border"] = Color3.fromRGB(44, 44, 44),
        ["Tab Background"] = Color3.fromRGB(20, 20, 20),
        ["Tab Border"] = Color3.fromRGB(48, 48, 48),
        ["Tab Toggle Background"] = Color3.fromRGB(27, 27, 27),
        ["Section Background"] = Color3.fromRGB(18, 18, 18),
        ["Section Border"] = Color3.fromRGB(34, 34, 34),
        ["Text"] = Color3.fromRGB(162, 162, 162),
        ["Disabled Text"] = Color3.fromRGB(108, 108, 108),
        ["Object Background"] = Color3.fromRGB(49, 49, 49),
        ["Object Border"] = Color3.fromRGB(13, 13, 13),
        ["Dropdown Option Background"] = Color3.fromRGB(48, 48, 48)
    }
}
...
function library:GetThemes()
    local themes = {"Default", "Midnight", 'Lime'}
